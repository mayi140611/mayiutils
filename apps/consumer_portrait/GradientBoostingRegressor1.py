...
@file: GradientBoostingRegressor1.py
@time: 2019/3/19 4:37
"""
...
if __name__ == '__main__':
    ...
    if mode == 2:
        ...
        n = 130
        m = 5
        model = GradientBoostingRegressor(learning_rate=l, n_estimators=n, max_depth=m)
        model.fit(X, y)
    ...
    if mode == 1:
        """
        利用网格搜索选择参数
        第一轮参数调优的最优结果0.1 120 5：3.8614787677759344 0.7903169685288672
        第二轮0.1 130 5：3.8608154790064275 0.7905325708497756
        """
