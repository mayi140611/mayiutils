...
MODELDIR="D:/data/fact_triple_extraction-master/ltp_data"
...
in_file_name = "D:/data/fact_triple_extraction-master/input.txt"
in_file_name = "D:/data/fact_triple_extraction-master/in2.txt"
out_file_name = "D:/data/fact_triple_extraction-master/output3.txt"
begin_line = 1
end_line = 0
...
def extraction_start(in_file_name, out_file_name, begin_line, end_line):
    ...
    Args:
        ...
        end_line: 读文件的结束行
    """
    in_file = open(in_file_name, 'r', encoding='utf8')
    out_file = open(out_file_name, 'a', encoding='utf8')
